...
+ (NSString *)targetName{
#if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
    return [[[NSBundle mainBundle] infoDictionary] objectForKey:@"TargetName"];
#else
    return nil;
#endif
}
...
+ (BOOL)isPhone35{
#if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
    return [YCBSystem isScreenSize:CGSizeMake(320, 480)];
#else
    return NO;
#endif
}
...
#if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
    return [YCBSystem isScreenSize:CGSizeMake(640, 960)];
#else
    return NO;
#endif
}
...
+ (BOOL)isPhoneRetina4{
#if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
    return [YCBSystem isScreenSize:CGSizeMake(640, 1136)];
#else
    return NO;
#endif
}
+ (BOOL)isPhoneRetina6{
#if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
    return [YCBSystem isScreenSize:CGSizeMake(750, 1334)];
#else
    return NO;
#endif
}
...
#if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
    return [YCBSystem isScreenSize:CGSizeMake(1242, 2208)];
#else
    return NO;
#endif
}
...
+ (BOOL)isPad{
#if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
    return [YCBSystem isScreenSize:CGSizeMake(768, 1024)];
#else
    return NO;
#endif
}
...
+ (BOOL)isPadRetina{
#if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
    return [YCBSystem isScreenSize:CGSizeMake(1536, 2048)];
#else
    return NO;
#endif
}
