...
- (void)setupUI
{
    ...
    // 头像
    _iconView = [DDImageView new];
    
    // 名字
    _nameLable = [UILabel labelWithTitle:@"" color:RGB(101, 200, 126) fontSize:14 alignment:NSTextAlignmentLeft];
    
    // 正文
    _contentLabel = [UILabel labelWithTitle:@"" color:[UIColor blackColor] fontSize:12 alignment:NSTextAlignmentLeft];
    ...
    [_moreButton setTitleColor:RGB(92, 140, 193) forState:UIControlStateNormal];
...
- (void)setViewModel:(LZMomentsViewModel *)viewModel
{
    ...
    [_iconView getImageWithURL:viewModel.status.iconName placeholder:@"usericon"];
