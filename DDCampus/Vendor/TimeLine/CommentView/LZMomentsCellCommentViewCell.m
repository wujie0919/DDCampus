...
//        self.selectionStyle = UITableViewCellSelectionStyleNone;
        ...
        UIColor *highLightColor = RGB(101, 200, 126);
        _likeLabel.linkTextAttributes = @{NSForegroundColorAttributeName : highLightColor};
        _likeLabel.activeLinkTextAttributes = @{NSForegroundColorAttributeName:RGB(101, 200, 126),NSBackgroundColorAttributeName:kDefaultActiveLinkBackgroundColorForMLLinkLabel};
