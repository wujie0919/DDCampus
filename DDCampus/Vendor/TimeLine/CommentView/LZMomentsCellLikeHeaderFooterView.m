...
//        _label.lineHeightMultiple = 1.1f;
        ...
        _label.activeLinkTextAttributes = @{NSForegroundColorAttributeName:RGB(101, 200, 126),NSBackgroundColorAttributeName:kDefaultActiveLinkBackgroundColorForMLLinkLabel};
