...
- (void)setupUI
{
    ...
    // 添加控件
    _likeButton = [self creatButtonWithTitle:@"赞" image:[UIImage imageNamed:@"zan"] selImage:[UIImage imageNamed:@""] target:self selector:@selector(likeButtonClicked)];
    _commentButton = [self creatButtonWithTitle:@"评论" image:[UIImage imageNamed:@"comment"] selImage:[UIImage imageNamed:@""] target:self selector:@selector(commentButtonClicked)];
