...
- (void)loopAction
{
    ...
    [_centerImageView getImageWithURL:_imglist[_currentImageIndex] placeholder:nil];
    
    leftImageIndex  = (_currentImageIndex + _imageCount - 1) % _imageCount ;
    rightImageIndex = (_currentImageIndex + 1) % _imageCount ;

    [_leftImageView getImageWithURL:_imglist[leftImageIndex] placeholder:nil];
    [_rightImageView getImageWithURL:_imglist[rightImageIndex] placeholder:nil];
...
- (void)setDefaultImage {
    //加载默认图片
    // set default center
    [_centerImageView getImageWithURL:_imglist[0] placeholder:nil];
    
    if (_imageCount > 1)
    {
        [_leftImageView getImageWithURL:_imglist[_imageCount - 1] placeholder:nil];
        [_rightImageView getImageWithURL:_imglist[1] placeholder:nil];
    }
