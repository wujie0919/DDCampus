...
const static CGFloat kCustomIOS7AlertViewCornerRadius              = 2.5f;//0;
...
//      if ([[[UIDevice currentDevice] systemVersion] floatValue] < 8.0) {
        ...
        [dialogView setCenter:self.center];
      }
    }
...
//    dialogContainer.layer.borderWidth = 1;
    ...
    dialogContainer.layer.shadowOpacity = .25f;//0.1f;
...
//        [closeButton setTitleColor:[UIColor colorWithRed:0.0f green:0.5f blue:1.0f alpha:1.0f]
                          forState:UIControlStateNormal];
        [closeButton setTitleColor:[UIColor colorWithRed:0.2f green:0.2f blue:0.2f alpha:0.5f]
